---
id: "a67eaca3-4f81-4dc1-9ac2-ff995043ab58"
title: "getrailo/railo"
notebook: "Railo - Tech stuff"
created: "2017-03-05T13:08:27+00:00"
updated: "2017-03-05T13:08:27+00:00"
deleted: false
...
Railo is a high performance, open source, CFML engine.  For more information visit the project's homepage at 
...
Java JDK
 - since you're going to compile Java code you need the JDK and not just the JRE.  Railo requires JDK 6 or later in order to compile.  
http://www.oracle.com/technetwork/java/javase/downloads/

Apache ANT
 - the source code contains several build scripts that will automate the build process for you. you will need ANT installed in order to run these build scripts. 
http://ant.apache.org/bindownload.cgi

A runnable copy of Railo
 - you will need a running instance of Railo on the local machine as part of the build process. 
...
Railo's source code is version-controlled with GIT and is hosted on github.com (
https://github.com/getrailo/railo
 - chances are that this is where you're reading this right now ;]).
...
Extract the contents of the ZIP archive into a work directory, e.g. /railo-source.  Inside that work directory you will now have the folders 
/railo-cfml
 and 
/railo-java
 and a few other files (including this one).
...
The easiest way to configure and run a local instance of Railo is by grabbing a copy of Railo Express from 
http://www.getrailo.org/index.cfm/download/

The root of that server should point to the 
/railo-cfml
 folder in the source code that you downloaded.  If you are using Railo Express, you can set that as follow:

Edit {railo-express}/contexts/railo.xml and modify the resourceBase element so that it points to the /railo-cfml folder, e.g.

<
Set name="resourceBase">
<
SystemProperty name="jetty.home" default="."/>C:/workspace/railo-source/railo-cfml/
<
/Set>
...
Start the Railo Express instance by running {railo-express}/start or {railo-express}/start.bat

Browse to the Admin of that Railo instance, e.g. http://localhost:8888/railo-context/admin/server.cfm and set the Admin's password.
...
You need to edit 
/railo-java/railo-core/build.properties
 and let the build script know where to find the local Railo instance.  

Change the line that reads 
railo.url=http://compile/compileAdmin.cfm
 so that the value of railo.url points to your local instance of Railo, e.g.
...
Simply edit the value of the number property so that it is higher than the version on the server that you plan to patch, for example: 
4.1.0.111
...
The build process should take a minute or two.  Once it's finished, you can find the newly built patch file in 
/railo-java/railo-core/dist/

The filename will be the version number that you've set in step 5, with the extension .rc, for example: 
4.1.0.111.rc
