...
created: 2018-05-31T13:58:54Z
updated: 2022-12-25T13:33:33Z
tags: []
...
(iv) Licenses granted by InnoCraft are granted subject to the condition that you must ensure the maximum number of Authorized Users that are able to access and use the Software is equal to the number of User Licenses for which the necessary fees have been paid to InnoCraft for the Subscription period. You may upgrade your license at any time on payment of the appropriate fees to InnoCraft in order to increase the maximum number of authorized users. **“User License”** means a license granted under this EULA to you to permit an Authorized User to use the Software. The number of User Licenses granted to you is dependent on the fees paid by you. **“Authorized User”** means a person who has an account in the Matomo instance and for which the necessary fees (**“Subscription fees”**) have been paid to InnoCraft for the current license term.
...
(vii) Any information that InnoCraft may collect from you or your device will be subject to InnoCraft Privacy Policy ([www.innocraft.com/privacy](<https://www.innocraft.com/privacy>)).

(viii) You are bound by the Matomo Marketplace Terms and Conditions ([shop.matomo.org/terms-conditions/](<https://shop.matomo.org/terms-conditions/>)).
...
Email: [contact@innocraft.com](<https://www.innocraft.com/licensemailto:contact@innocraft.com>)

Contact form: [www.innocraft.com/#contact](<https://www.innocraft.com/#contact>)

Website: [www.innocraft.com](<https://www.innocraft.com/>)

Buy our products: [Premium Plugins for Matomo Analytics](<https://plugins.matomo.org/premium>)
